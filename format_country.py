...
if __name__ == "__main__":
    ...
    with open("./out/world-ares.json",'w', encoding="utf-8") as out_file:
    ...
    for geojson_country_name in file_list:
        if geojson_country_name[-6:] == "0.json":
            ...
            with open(path_geojson + "\\" + geojson_country_name,"r", encoding="utf-8") as f_geojson_country:
            ...
            obj_country["features"][0]["properties"]["name"] = obj_country["features"][0]["properties"].pop("NAME_0")
